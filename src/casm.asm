...
.push_node:
  ...
  PAR_NODE G_CTRL, 0x68, 0, 1, IMM32_BIT, IMM + TERM
  PAR_NODE G_CTRL, 0xFF, 0, 0, MEM32_BIT, MEM + MODRM + SIB + OPNUM7 + TERM

.pop_node:
  PAR_NODE G_REG32, 0x58, 0, 0, 0, SHORT_OP + TERM

.call_node:
  PAR_NODE G_CTRL, 0xE8, 0, 1, IMM32_BIT, IMM + TERM
  PAR_NODE G_CTRL, 0xFF, 0, 1, MEM32_BIT, MEM + MODRM + SIB + OPNUM3 + TERM
...
.jmp_node:
  PAR_NODE G_CTRL, 0xE9, 0, 1, IMM32_BIT, IMM + TERM
  PAR_NODE G_CTRL, 0xFF, 0, 1, MEM32_BIT, MEM + SIB + MODRM + OPNUM4 + TERM
...
.or_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    ...
    PAR_NODE G_REG32, 0x09, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x09, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x08, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, IMM + MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x0B, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG32, 0x0B, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x08, 0, 1, MEM8_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x08, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM16_BIT, OPSIZE + IMM + MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + IMM + MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x0B, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x0B, 0, 0, 0, OPSIZE + MODRM + TERM

.and_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, MEM8_BIT + IMM8_BIT, MEM + IMM + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM32_BIT + IMM32_BIT, MEM + IMM + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM16_BIT + IMM16_BIT, OPSIZE + MEM + IMM + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MEM + IMM + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MEM + IMM + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_REG32, 0x21, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x21, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x20, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, IMM + MODRM + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x23, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG32, 0x23, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x20, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x20, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM16_BIT, OPSIZE + IMM + MODRM + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + IMM + MODRM + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x23, 0, 0, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x23, 0, 0, 0, OPSIZE + MODRM + TERM

.add_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, MEM8_BIT + IMM8_BIT, MEM + IMM + MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM32_BIT + IMM32_BIT, MEM + IMM + MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM16_BIT + IMM16_BIT, OPSIZE + MEM + IMM + MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MEM + IMM + MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MEM + IMM + MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_REG32, 0x01, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x01, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x00, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, IMM + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x03, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG32, 0x03, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x00, 0, 1, MEM8_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x03, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM16_BIT, OPSIZE + IMM + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + IMM + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x03, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x03, 0, 0, 0, OPSIZE + MODRM + TERM

.xor_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, MEM8_BIT + IMM8_BIT, MEM + IMM + MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM32_BIT + IMM32_BIT, MEM + IMM + MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM16_BIT + IMM16_BIT, OPSIZE + MEM + IMM + MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MEM + IMM + MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MEM + IMM + MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_REG32, 0x31, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x31, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x30, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, IMM + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x33, 0, 1, MEM32_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG32, 0x33, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x30, 0, 1, MEM8_BIT, MEM + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x30, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM16_BIT, OPSIZE + IMM + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + IMM + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x33, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x33, 0, 0, 0, OPSIZE + MODRM + TERM
...
.not_node:
  ...
  PAR_NODE G_CTRL, 0xF7, 0, 1, MEM8_BIT, MEM + MODRM + OPNUM3 + TERM
  PAR_NODE G_CTRL, 0xF7, 0, 1, MEM32_BIT, MEM + MODRM + OPNUM3 + TERM
  PAR_NODE G_CTRL, 0xF7, 0, 0, MEM16_BIT, OPSIZE + MEM + MODRM + OPNUM3 + TERM

.int_node:
  PAR_NODE G_CTRL, 0xCD, 0, 0, IMM8_BIT, IMM + TERM

.inc_node:
  PAR_NODE G_CTRL, 0xFE, 0, 1, MEM8_BIT, MEM + SIB + MODRM + OPNUM1 + TERM
  PAR_NODE G_CTRL, 0xFF, 0, 1, MEM32_BIT, MEM + SIB + MODRM + OPNUM1 + TERM
  PAR_NODE G_CTRL, 0xFF, 0, 1, MEM16_BIT, OPSIZE + SIB + MODRM + OPNUM1 + TERM
  PAR_NODE G_REG32, 0x40, 0, 0, 0, SHORT_OP + TERM

.dec_node:
  PAR_NODE G_CTRL, 0xFE, 0, 1, MEM8_BIT, MEM + SIB + MODRM + OPNUM2 + TERM
  PAR_NODE G_CTRL, 0xFF, 0, 1, MEM32_BIT, MEM + SIB + MODRM + OPNUM2 + TERM
...
.je_node:
  PAR_NODE G_CTRL, 0x84, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jz_node:
  PAR_NODE G_CTRL, 0x84, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jl_node:
  PAR_NODE G_CTRL, 0x8C, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jle_node:
  PAR_NODE G_CTRL, 0x8E, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jg_node:
  PAR_NODE G_CTRL, 0x8F, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jge_node:
  PAR_NODE G_CTRL, 0x8D, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.ja_node:
  PAR_NODE G_CTRL, 0x87, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jae_node:
  PAR_NODE G_CTRL, 0x82, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jb_node:
  PAR_NODE G_CTRL, 0x82, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jbe_node:
  PAR_NODE G_CTRL, 0x86, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jc_node:
  PAR_NODE G_CTRL, 0x82, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.js_node:
  PAR_NODE G_CTRL, 0x88, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jo_node:
  PAR_NODE G_CTRL, 0x80, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jp_node:
  PAR_NODE G_CTRL, 0x8A, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jpo_node:
  PAR_NODE G_CTRL, 0x8B, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jpe_node:
  PAR_NODE G_CTRL, 0x8A, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jne_node:
  PAR_NODE G_CTRL, 0x85, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jnz_node:
  PAR_NODE G_CTRL, 0x85, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jnc_node:
  PAR_NODE G_CTRL, 0x83, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jns_node:
  PAR_NODE G_CTRL, 0x89, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM

.jno_node:
  PAR_NODE G_CTRL, 0x81, 0, 0, IMM32_BIT, TWOBYTE + IMM + TERM
...
.movzx_node:
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0xB6, 0, 1, MEM8_BIT, TWOBYTE + MEM + TERM
    PAR_NODE G_REG8, 0xB6, 0, 1, 0, TWOBYTE + MODRM + TERM
    PAR_NODE G_REG16, 0xB7, 0, 0, 0, TWOBYTE + MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0xB6, 0, 1, MEM8_BIT, OPSIZE + TWOBYTE + MEM + TERM
    PAR_NODE G_REG8, 0xB6, 0, 0, 0, OPSIZE + TWOBYTE + MEM + TERM

.movsx_node:
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0xBE, 0, 1, MEM8_BIT, TWOBYTE + MEM + TERM
    PAR_NODE G_REG8, 0xBE, 0, 1, 0, TWOBYTE + MODRM + TERM
    PAR_NODE G_REG16, 0xBF, 0, 0, 0, TWOBYTE + MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0xBE, 0, 1, MEM8_BIT, OPSIZE + TWOBYTE + MEM + TERM
    PAR_NODE G_REG8, 0xBE, 0, 0, 0, OPSIZE + TWOBYTE + MEM + TERM
