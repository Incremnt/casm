...
.cmp_node:
  PAR_NODE G_CTRL, 0x00, 1, 7, 0, 0
    ...
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM32_BIT + IMM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_CTRL, 0x80, 0, 1, MEM8_BIT + IMM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_CTRL, 0x81, 0, 0, MEM16_BIT + IMM16_BIT, OPSIZE + MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
...
.add_node:
  ...
  PAR_NODE G_REG32, 0x00, 1, 5, 0, 0
    ...
    PAR_NODE G_CTRL, 0x01, 0, 1, MEM32_BIT, MODRM + SIB + TERM
...
.sub_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    ...
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MODRM + SIB + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_REG32, 0x29, 0, 1, MEM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x29, 0, 1, MEM16_BIT, OPSIZE + MODRM + SIB + TERM
