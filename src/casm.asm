...
.call_node:
  PAR_NODE G_CTRL, 0xE8, 0, 1, IMM32_BIT, TERM
...
.cmp_node:
  PAR_NODE G_CTRL, 0x00, 1, 4, 0, 0
    ...
    PAR_NODE G_REG16, 0x39, 0, 0, MEM16_BIT, OPSIZE + MODRM + SIB + TERM
...
.jmp_node:
  PAR_NODE G_CTRL, 0xE9, 0, 1, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0xFF, 0, 1, MEM32_BIT, SIB + MODRM + OPNUM4 + TERM
...
.or_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    ...
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MODRM + SIB + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MODRM + SIB + OPNUM2 + TERM
    PAR_NODE G_REG32, 0x09, 0, 1, MEM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x09, 0, 1, MEM16_BIT, OPSIZE + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x08, 0, 0, MEM8_BIT, MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, MODRM + OPNUM2 + TERM
  ...
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    ...
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + MODRM + OPNUM2 + TERM
...
.and_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    ...
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MODRM + SIB + OPNUM5 + TERM
    PAR_NODE G_REG32, 0x21, 0, 1, MEM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x21, 0, 1, MEM16_BIT, OPSIZE + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x20, 0, 0, MEM8_BIT, MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, MODRM + OPNUM5 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, MODRM + OPNUM5 + TERM
  ...
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    ...
    PAR_NODE G_CTRL, 0x20, 0, 0, MEM8_BIT, MODRM + SIB + TERM
...
.add_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    ...
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MODRM + SIB + OPNUM1 + TERM
    PAR_NODE G_REG32, 0x01, 0, 1, MEM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x01, 0, 1, MEM16_BIT, OPSIZE + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x00, 0, 0, MEM8_BIT, MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, MODRM + OPNUM1 + TERM
  ...
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    ...
    PAR_NODE G_CTRL, 0x00, 0, 1, MEM8_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x03, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM16_BIT, OPSIZE + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + MODRM + OPNUM1 + TERM
...
.xor_node:
  PAR_NODE G_CTRL, 0x00, 1, 9, 0, 0
    ...
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM32_BIT + IMM8_BIT, MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, MEM16_BIT + IMM8_BIT, OPSIZE + MODRM + SIB + OPNUM7 + TERM
    PAR_NODE G_REG32, 0x31, 0, 1, MEM32_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG16, 0x31, 0, 1, MEM16_BIT, OPSIZE + MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x30, 0, 0, MEM8_BIT, MODRM + SIB + TERM
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM32_BIT, MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, MODRM + OPNUM7 + TERM
  ...
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    ...
    PAR_NODE G_CTRL, 0x30, 0, 1, MEM8_BIT, MODRM + SIB + TERM
    PAR_NODE G_REG8, 0x30, 0, 0, 0, MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, IMM16_BIT, OPSIZE + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x83, 0, 1, IMM8_BIT, OPSIZE + MODRM + OPNUM7 + TERM
...
.je_node:
  PAR_NODE G_CTRL, 0x84, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jz_node:
  PAR_NODE G_CTRL, 0x84, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jl_node:
  PAR_NODE G_CTRL, 0x8C, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jle_node:
  PAR_NODE G_CTRL, 0x8E, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jg_node:
  PAR_NODE G_CTRL, 0x8F, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jge_node:
  PAR_NODE G_CTRL, 0x8D, 0, 0, IMM32_BIT, TWOBYTE + TERM

.ja_node:
  PAR_NODE G_CTRL, 0x87, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jae_node:
  PAR_NODE G_CTRL, 0x82, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jb_node:
  PAR_NODE G_CTRL, 0x82, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jbe_node:
  PAR_NODE G_CTRL, 0x86, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jc_node:
  PAR_NODE G_CTRL, 0x82, 0, 0, IMM32_BIT, TWOBYTE + TERM

.js_node:
  PAR_NODE G_CTRL, 0x88, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jo_node:
  PAR_NODE G_CTRL, 0x80, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jp_node:
  PAR_NODE G_CTRL, 0x8A, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jpo_node:
  PAR_NODE G_CTRL, 0x8B, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jpe_node:
  PAR_NODE G_CTRL, 0x8A, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jne_node:
  PAR_NODE G_CTRL, 0x85, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jnz_node:
  PAR_NODE G_CTRL, 0x85, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jnc_node:
  PAR_NODE G_CTRL, 0x83, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jns_node:
  PAR_NODE G_CTRL, 0x89, 0, 0, IMM32_BIT, TWOBYTE + TERM

.jno_node:
  PAR_NODE G_CTRL, 0x81, 0, 0, IMM32_BIT, TWOBYTE + TERM
...
.movzx_node:
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0xB6, 0, 1, MEM8_BIT, TWOBYTE + TERM
    PAR_NODE G_REG8, 0xB6, 0, 1, 0, TWOBYTE + MODRM + TERM
    PAR_NODE G_REG16, 0xB7, 0, 0, 0, TWOBYTE + MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0xB6, 0, 1, MEM8_BIT, OPSIZE + TWOBYTE + TERM
    PAR_NODE G_REG8, 0xB6, 0, 0, 0, OPSIZE + TWOBYTE + TERM

.movsx_node:
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    PAR_NODE G_CTRL, 0xBE, 0, 1, MEM8_BIT, TWOBYTE + TERM
    PAR_NODE G_REG8, 0xBE, 0, 1, 0, TWOBYTE + MODRM + TERM
    PAR_NODE G_REG16, 0xBF, 0, 0, 0, TWOBYTE + MODRM + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    PAR_NODE G_CTRL, 0xBE, 0, 1, MEM8_BIT, OPSIZE + TWOBYTE + TERM
    PAR_NODE G_REG8, 0xBE, 0, 0, 0, OPSIZE + TWOBYTE + TERM
