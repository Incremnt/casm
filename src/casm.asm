...
.cmp_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x3C, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x3D, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x3D, 0, 0, IMM32_BIT, TERM
...
.or_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x0C, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x0D, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x0D, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM32_BIT, 0
...
.and_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x24, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x25, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x25, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM32_BIT, 0
...
.add_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x04, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x05, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x05, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM32_BIT, 0
...
.xor_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x34, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x35, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x35, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM32_BIT, 0
...
.sub_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x2C, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x2D, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x2D, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM8_BIT, 0
...
.adc_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x14, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x15, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x15, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM32_BIT, 0
...
.sbb_node:
  PAR_NODE R8_AL, 0x00, 1, 2, REG8_BIT, 0
    PAR_NODE G_CTRL, 0x1C, 0, 0, IMM8_BIT, TERM
  PAR_NODE R16_AX, 0x00, 1, 2, REG16_BIT, 0
    PAR_NODE G_CTRL, 0x1D, 0, 0, IMM16_BIT, OPSIZE + TERM
  PAR_NODE R32_EAX, 0x00, 1, 2, REG32_BIT, 0
    PAR_NODE G_CTRL, 0x1D, 0, 0, IMM32_BIT, TERM
  PAR_NODE G_CTRL, 0x00, 1, 3, MEM32_BIT, 0
    PAR_NODE G_CTRL, 0x81, 0, 1, MEM32_BIT + IMM32_BIT, MODRM + SIB + OPNUM4 + TERM
