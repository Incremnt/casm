...
.or_node:
  ...
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    ...
    PAR_NODE G_CTRL, 0x0B, 0, 0, MEM32_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM2 + TERM
    PAR_NODE G_CTRL, 0x08, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    ...
    PAR_NODE G_CTRL, 0x0B, 0, 0, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
...
.and_node:
  ...
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    ...
    PAR_NODE G_CTRL, 0x23, 0, 0, MEM32_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
...
.add_node:
  ...
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    ...
    PAR_NODE G_CTRL, 0x03, 0, 0, MEM32_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM1 + TERM
    PAR_NODE G_CTRL, 0x00, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    ...
    PAR_NODE G_CTRL, 0x03, 0, 0, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
...
.xor_node:
  ...
  PAR_NODE G_REG32, 0x00, 1, 4, 0, 0
    ...
    PAR_NODE G_CTRL, 0x33, 0, 0, MEM32_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG8, 0x00, 1, 3, 0, 0
    PAR_NODE G_CTRL, 0x80, 0, 1, IMM8_BIT, IMM + MODRM + OPNUM7 + TERM
    PAR_NODE G_CTRL, 0x30, 0, 0, MEM8_BIT, MEM + MODRM + SIB + TERM
  PAR_NODE G_REG16, 0x00, 1, 0, 0, 0
    ...
    PAR_NODE G_CTRL, 0x33, 0, 0, MEM16_BIT, OPSIZE + MEM + MODRM + SIB + TERM
...
.not_node:
  ...
  PAR_NODE G_CTRL, 0xF7, 0, 1, MEM16_BIT, OPSIZE + MEM + MODRM + OPNUM3 + TERM
